...
public class ObjectId implements Comparable<ObjectId> , java.io.Serializable {
    ...
    static final String LogTag = "tinysync.db.ObjectId";
     ...
     * @see com.tinymission.tinysync.db.ObjectId#ObjectId(int, int, int)
     * @since 2.12.0
     */
     ...
     *             Please use {@link com.tinymission.tinysync.db.ObjectId#ObjectId(byte[])} or
    ...
    static {
        ...
        try {
            ...
            int machinePiece;
            {
                ...
                Log.v(LogTag, "machine piece post: " + Integer.toHexString( machinePiece ) );
            }
...
//                    processId = java.lang.management.ManagementFactory.getRuntimeMXBean().getName().hashCode();
                ...
                Log.v(LogTag, "process piece: " + Integer.toHexString(processPiece));
            }

            _genmachine = machinePiece | processPiece;
            Log.v(LogTag, "machine : " + Integer.toHexString( _genmachine ) );
        }
        catch ( Exception e ){
